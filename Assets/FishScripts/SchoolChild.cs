...
public class SchoolChild:MonoBehaviour{
	...
	public void SetAnimationSpeed(){
		...
		//fishMaterial.SetFloat("fishWaveSpeed", (Random.Range(_spawner._minAnimationSpeed, _spawner._maxAnimationSpeed) * _spawner._schoolSpeed * this._speed) + .1f);
		fishMaterial.SetFloat("fishWaveSpeed", Mathf.Clamp((_spawner._schoolSpeed * this._speed), _spawner._minAnimationSpeed, _spawner._maxAnimationSpeed));
	}
