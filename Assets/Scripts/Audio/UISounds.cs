...
namespace ShipAudio
{
    public class UISounds : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler, IPointerUpHandler, IPointerClickHandler
    {
        ...
        [Header("Hover State")]
        [SerializeField] private string m_EnterEvent = "ui.hover";
        ...
        [SerializeField] private string m_ClickEvent = "ui.click";
        ...
        private void TryPlay(string inEventId, bool inbCheckPrevState)
        {
            ...
            {
                if (!m_Selectable.IsReferenceNull() && !m_Selectable.IsInteractable())
                    return;
            }
            
            AudioMgr.Instance.PostEvent(inEventId);
        }
